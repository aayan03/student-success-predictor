...
from utils.model_utils import load_model_variant, load_saved_model, predict_student
...
def main() -> None:
    ...
    default_model, default_metadata = load_saved_model(MODEL_DIR)
    ...
    model, metadata = load_model_variant(MODEL_DIR, include_marks)
    ...
    if submitted:
        result = predict_student(model, student_data)
