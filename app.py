...
def load_css() -> None:
    ...
    .creator-strip {
        ...
        background:
            linear-gradient(135deg, rgba(6, 182, 212, 0.14), rgba(124, 58, 237, 0.16)),
...
def render_sidebar() -> None:
    with st.sidebar:
        ...
        st.divider()
        st.caption("Created by Aayan, Ayush, and Aniruddh.")
...
def render_home() -> None:
    ...
    st.markdown('<div class="section-title">How The Prediction Works</div>', unsafe_allow_html=True)
    st.markdown(
        """
        <div class="feature-grid">
            <div class="feature-card">
                <h3>1. Explore Data</h3>
                <p>Review records, missing values, distributions, and correlations before model training.</p>
            </div>
            <div class="feature-card">
                <h3>2. Train Two Modes</h3>
                <p>Build one model using profile parameters only and another model that can include marks.</p>
            </div>
            <div class="feature-card">
                <h3>3. Predict Outcomes</h3>
                <p>Choose whether marks should be used, submit student details, and get a pass/fail result.</p>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div class="creator-strip">
            <div style="color:#cbd5e1;font-weight:700;">Website created by</div>
            <div class="creator-names">
                <div class="creator-pill">Aayan</div>
                <div class="creator-pill">Ayush</div>
                <div class="creator-pill">Aniruddh</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
